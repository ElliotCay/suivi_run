...
const DISTANCES = [
  ...
  { value: '1_mile', label: '1 mile (1.6 km)', km: 1.6 },
  ...
  { value: 'semi', label: 'Semi-marathon (21.1 km)', km: 21.1 },
  { value: 'marathon', label: 'Marathon (42.2 km)', km: 42.2 },
]
                  ...
                  <div className="space-y-2">
                    <div className="flex items-baseline gap-4">
                      ...
                      <div className="text-xl text-muted-foreground">
                        {calculatePace(record.time_seconds, km)}
                      </div>
                    </div>
