      ...
      <div className="sticky top-0 h-screen flex items-center overflow-hidden">
        <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="hidden lg:flex items-center justify-center">
            ...
            >
              {/* Subtle orb background - minimal gradient */}
              <div className="absolute inset-0 rounded-full bg-[#ee95b3]/5 blur-3xl" />

              {/* Glass card mockup */}
              <motion.div
                className="relative w-full h-full rounded-3xl bg-white/5 backdrop-blur-xl border border-black/10 p-8 flex flex-col justify-between overflow-hidden"
                style={{
                  boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15), inset 0 1px 0 0 rgba(255, 255, 255, 0.05)'
                }}
                whileHover={{
                  y: -4,
                  scale: 1.01,
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="text-[#1A1A1A]/50 text-sm font-medium mb-2">Prochaine séance</div>
                  <div className="text-[#1A1A1A] text-xl font-semibold">Tempo 8km</div>
                </div>
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-[#1A1A1A]/60">Charge optimale</span>
                    <span className="text-[#1A1A1A] font-mono italic">72%</span>
                  </div>
                </div>

                <div className="relative z-10 grid grid-cols-3 gap-4 pt-4 border-t border-black/10">
                  {[
                    ...
                    <div key={stat.label} className="text-center">
                      <div className="text-[#1A1A1A] font-mono text-lg italic">{stat.value}</div>
                      <div className="text-[#1A1A1A]/40 text-xs">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
...
function FeatureText({
  ...
  return (
    ...
    >
      {/* Feature number - removed gradient */}
      <div className="flex items-baseline gap-4 mb-6">
        <span className="text-7xl md:text-8xl font-mono italic text-[#1A1A1A]">
          0{feature.id}
        </span>
      ...
      {/* Feature title */}
      <h3 className="text-4xl md:text-5xl font-serif font-bold text-[#1A1A1A] mb-4 tracking-tight">
        {feature.title}
      </h3>

      {/* Feature description */}
      <p className="text-lg md:text-xl text-[#1A1A1A]/70 leading-relaxed mb-8 max-w-md">
        {feature.description}
      </p>

      {/* Feature metric */}
      <div className="inline-flex items-center gap-4 px-6 py-4 rounded-2xl bg-white/8 backdrop-blur-sm border border-black/10 w-fit">
        <span className="text-3xl font-mono italic text-[#1A1A1A]">{feature.metric}</span>
        <span className="text-[#1A1A1A]/50">{feature.metricLabel}</span>
      </div>
    </motion.div>
  );
}
...
function ScrollIndicator() {
  return (
    ...
    >
      <span className="text-[#1A1A1A]/50 text-sm tracking-widest uppercase">Scroll</span>
      <motion.div
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <section className="relative h-[200vh]">
        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            {/* Logo - Massive */}
            <motion.h1
              className="font-branch text-[120px] md:text-[180px] lg:text-[220px] text-[#1A1A1A] leading-none tracking-tight"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
              style={{
                textShadow: '0 4px 60px rgba(0, 0, 0, 0.1)',
              }}
            >
              allure
            </motion.h1>
            ...
            {/* Tagline */}
            <motion.p
              className="text-[#1A1A1A]/70 text-xl md:text-2xl font-light mt-4 tracking-wide"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <div className="grid grid-cols-3 gap-8 md:gap-16 px-6">
              {heroStats.map((stat, index) => (
                ...
                >
                  <div className="text-5xl md:text-7xl font-mono italic text-[#1A1A1A] font-bold tracking-tight">
                    {stat.value}
                  </div>
                  <div className="text-[#1A1A1A]/50 text-sm md:text-base mt-2 uppercase tracking-widest">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
      ...
      <section className="relative min-h-screen bg-[#FAFAF9] flex items-center overflow-hidden">
        {/* Subtle gradient background - very minimal */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#ee95b3]/3 via-transparent to-[#667abf]/3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <motion.div
                ...
                className="mb-8"
              >
                <span className="text-[#1A1A1A]/40 text-sm uppercase tracking-[0.3em]">
              ...
              <AnimatedWords
                text={accroche}
                className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-[#1A1A1A] leading-[1.1] tracking-tight"
              />

              <motion.p
                className="text-[#1A1A1A]/60 text-lg md:text-xl mt-8 max-w-md leading-relaxed"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="relative">
                {/* Glow effect - subtle */}
                <div className="absolute -inset-20 bg-[#ee95b3]/8 blur-3xl rounded-full" />

                {/* Phone frame */}
                <motion.div
                  className="relative w-[280px] md:w-[320px] aspect-[9/19] rounded-[3rem] bg-gradient-to-b from-white/10 to-white/5 border border-black/10 overflow-hidden"
                  style={{
                    boxShadow: '0 50px 100px -20px rgba(0, 0, 0, 0.2), inset 0 1px 0 0 rgba(255, 255, 255, 0.05)'
                  }}
                  animate={{
                    y: [0, -10, 0],
                  }}
      ...
      {/* ================================================================== */}
      <section className="relative min-h-screen bg-[#FAFAF9] flex items-center justify-center overflow-hidden">
        {/* Background gradient orbs - very subtle */}
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#ee95b3]/5 rounded-full blur-[150px]" />
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#667abf]/5 rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-[#1A1A1A] mb-6 tracking-tight">
              Prêt à progresser ?
            </h2>

            <p className="text-[#1A1A1A]/50 text-lg md:text-xl max-w-md mx-auto mb-12">
            ...
            <MagneticButton>
              <Link href="/import">
                <Button
                  size="lg"
                  className="group relative text-lg md:text-xl px-12 py-8 bg-gradient-to-r from-[#ee95b3] to-[#667abf] text-white hover:scale-105 transition-all duration-300 font-bold rounded-full overflow-hidden border-0"
                  style={{
                    boxShadow: '0 0 60px rgba(238, 149, 179, 0.3), 0 20px 40px -10px rgba(0, 0, 0, 0.2)'
                  }}
                >
            ...
            <motion.div
              className="flex items-center justify-center gap-8 mt-16 text-[#1A1A1A]/30 text-sm"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
      ...
      {/* FOOTER - Minimal */}
      {/* ================================================================== */}
      <footer className="bg-[#FAFAF9] border-t border-black/5 py-12">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="font-branch text-3xl text-[#1A1A1A]/80">allure</div>
            <div className="text-[#1A1A1A]/30 text-sm">
